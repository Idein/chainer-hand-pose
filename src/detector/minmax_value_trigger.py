...
class BestValueTrigger(object):
    ...
    def __call__(self, trainer):
        ...
        # if load snapshot, _iter equals 0 and iteration equals last iteration when saved snapshot.
        # In such case, {MinValue, MaxValue}Trigger is fire, though key(line 58) does not exist.
        if not self._interval_trigger(trainer) or abs(iteration - self._iter) > 1:
